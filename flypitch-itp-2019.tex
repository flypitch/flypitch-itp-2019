...
\supplement{\label{supplement}\url{https://github.com/flypitch/flypitch}}%optional, e.g. related research data, source code, ... hosted on a repository like zenodo, figshare, GitHub, ...
